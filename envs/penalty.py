...
from rsoccer_gym.vss.vss_gym_base import VSSBaseEnv, RSimVSS
...
class VSSPenaltyEnv(VSSBaseEnv):
    ...
    def __init__(self, render_mode=None, repeat_action=1, max_steps=500):
        ...
        self.action_space = gym.spaces.Box(low=-MAX_W_ANGULAR, high=MAX_W_ANGULAR,
                                           shape=(OUTPUT_SIZE, ), dtype=np.float32)
    ...
    def _get_initial_positions_frame(self):
        ...
        def x(): return random.uniform(-field_half_width + 0.1,
                                       field_half_width - 0.1)

        def y(): return random.uniform(-field_half_length/2 + 0.1, field_half_length/2 - 0.1)
